...
public class Report implements Serializable {
    ...
    private LocalDateTime begin_time;   //实训开始时间
    private LocalDateTime end_time;     //实训结束时间
