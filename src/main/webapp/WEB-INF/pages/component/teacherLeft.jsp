...
<div style="background-color:rgb(32,34,42);  height: 100%; float: left; width: 15%">
    <a class="navbar-brand" href="teacherToHome">
        <img src="imgs/logo.png" width="100%" height="6%" alt="武汉晴川学院" loading="lazy">
    </a>
    <a id="studentManagement" href="teacherGradeInformation" class="btn btn-outline-secondary btn-lg btn-block clear-fillet" style="margin: 0px;">学生管理</a>
    <a id="paperManagement" href="teacherGetReport" class="btn btn-outline-secondary btn-lg btn-block clear-fillet" style="margin: 0px;">实训报告</a>
    <div class="btn btn-outline-secondary btn-lg btn-block clear-fillet dropdown-toggle" id="teacherPersonalCenter">
        <i class="fa fa-user-o fa-lg" aria-hidden="true"></i>个人中心
    </div>
    <div style="background-color: rgb(22,24,29); ">
        <a href="teacherPersonInformation"><div class="btn btn-outline-light btn-lg btn-block clear-fillet" id="b4">个人信息</div></a>
