    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${allStudent}" var="s" varStatus="status">
            ...
            <tr align="center">
                ...
                <td>${s.student.s_id}</td>
                <td>${s.student.s_name}</td>
                <td>${s.grade.c_name}</td>
                <td>${s.student.s_phone}</td>
                <td>${s.student.s_college}</td>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="updateStudentsInformation" method="post">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="s_id" id="studentId" value="${s.student.s_id}">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="s_college" id="studentCollege" value="${s.student.s_college}">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label for="studentCompany" class="input-group-text">实训公司</label>
                                    </div>
                                    <input type="text" class="form-control" name="company_name" id="studentCompany" value="${s.company.company_name}">
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="deleteStudentsInformation" method="post" >
                                <input style="display: none" type="text" class="form-control" name="s_id" value="${s.student.s_id}">
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
