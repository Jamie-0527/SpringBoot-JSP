        ...
        <ul class="pagination justify-content-center">
            <c:choose>
                <c:when test="${pageNum > 1}">
                    <li class="page-item">
                        <a class="page-link" href="companyManagement?page=${pageNum-1 }" tabindex="-1">Previous</a>
                    </li>
                </c:when>
                <c:otherwise>
            ...
            <c:choose>
                <c:when test="${pageNum < pageCount}">
                    <li class="page-item">
                        <a class="page-link" href="companyManagement?page=${pageNum+1 }" tabindex="-1">Next</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li class="page-item disabled">
